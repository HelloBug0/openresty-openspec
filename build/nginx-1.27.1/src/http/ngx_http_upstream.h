...
typedef struct {
    ...
    ngx_array_t                      bind_pools;
                                             /* ngx_http_upstream_bind_pool_t */
...
typedef struct {
    ...
    time_t                           fail_timeout;
    unsigned                         backup:1;
} ngx_http_upstream_bind_peer_t;


typedef struct {
    ngx_str_t                        name;
    ngx_array_t                      peers;  /* ngx_http_upstream_bind_peer_t */
...
#define NGX_HTTP_UPS_BP_CONF            0x00020000
...
typedef struct {
    ...
    ngx_http_upstream_bind_pool_t   *bind_pool;
    ngx_str_t                        bind_pool_name;
